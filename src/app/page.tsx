      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-500/10 text-indigo-500 rounded-full text-xs font-bold uppercase tracking-widest mb-6"
          >
          ...
          >
            Mora는 수만 개의 글로벌 뉴스, 커뮤니티 데이터, 그리고 경제 지표를
            AI가 초단위로 분석합니다.
            <span className="block mt-2 font-semibold text-foreground italic">
              &quot;매일 아침 7시(KST), 당일의 새로운 시장 흐름을 날카롭게
              요약하고 한눈에 보기 좋게 정리합니다.&quot;
            </span>
          </motion.p>
          ...
          <motion.div variants={itemVariants} className="flex justify-center">
            <Link href="/radar">
              <Button
                size="lg"
                className="h-14 px-8 text-lg font-bold rounded-2xl bg-indigo-600 hover:bg-indigo-700 shadow-xl shadow-indigo-500/20 group"
              >
                오늘의 시장 확인하기
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              방대한 데이터를 지능적으로 요약하여 명확한 투자 인사이트를
              제공합니다.
            </p>
          </div>
            ...
            <ul className="space-y-6">
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    AI 답변의 모든 내용은 10개 이상의 실제 뉴스 링크로
                    뒷받침됩니다.
                  </p>
                </div>
              </li>
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    시장의 긍정/부정적 심리 점수를 수치화하여 객관적인 지표를
                    제공합니다.
                  </p>
                </div>
              </li>
